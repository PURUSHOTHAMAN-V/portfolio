          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div className="space-y-8">
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                ...
                <a href="/resume.pdf" download className="btn-secondary flex items-center justify-center space-x-2">
              ...
              <div className="flex space-x-4">
                {socialLinks.map((link) => (
                  <a
                    ...
                    className="p-3 rounded-lg bg-white dark:bg-dark-800 shadow-md border border-gray-200 dark:border-dark-700 transition-all duration-200 hover:scale-105"
                  >
            ...
            <div className="flex justify-center lg:justify-end">
              <div className="w-80 h-80 bg-gradient-to-br from-primary-400 to-blue-600 rounded-full flex items-center justify-center shadow-2xl relative">
                {/* Profile Photo */}
                <img
                  src="/profile.jpg"
                  alt="Profile"
