...
const About = () => {
  ...
  const timeline = [
    ...
    },
    {
      ...
      description: "Working on complex projects involving AI, machine learning, and advanced web technologies."
    }
  ];
        ...
        <div className="container-custom">
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-gray-600 dark:text-gray-400 max-w-3xl mx-auto">
              A passionate final-year B.Tech IT student with a strong foundation in web development, 
          ...
          <div className="max-w-4xl mx-auto text-center">
            ...
            <div className="card">
              <p className="text-lg text-gray-600 dark:text-gray-400 leading-relaxed mb-6">
                As a final-year B.Tech Information Technology student, I am passionate about leveraging 
